...
const cases = [
  ...
  {
    id: "margin-workspace",
    name: "margin workspace",
    path: "/margin?browserAuth=authenticated",
    heading: "Margin",
    actions: ['[data-testid="margin-page-heading"]'],
    requiredSelectors: [
      '[data-testid="margin-page-heading"]',
      '[data-testid="margin-basis-statement"]',
      '[data-testid="margin-summary-metrics"]',
      '[data-testid="margin-filter-controls"]',
      '[data-testid="margin-record-quote-8101"]',
      '[data-testid="margin-record-order-8202"]',
    ],
    requiredTexts: ["Financial workspace", "Margin register", "Margin %", "33%"],
    shell: true,
    skipVisual: true,
  },
  {
