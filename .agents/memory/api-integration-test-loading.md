...
**How to apply:** Pure unit tests can continue using native type stripping. Tests that import the Express app or database package should run through the integration bundling harness.