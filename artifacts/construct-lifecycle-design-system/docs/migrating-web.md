# Migrating web UI to Construct Lifecycle Design System

Read `artifacts/construct-lifecycle-design-system/docs/AGENTS.md` and
`artifacts/construct-lifecycle-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/construct-lifecycle-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/construct-lifecycle-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/construct-lifecycle-design-system/hooks/use-toast`
