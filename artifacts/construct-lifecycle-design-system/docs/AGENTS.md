# Construct Lifecycle Design System design system
...
workspace package (`@workspace/construct-lifecycle-design-system`): other artifacts depend
...
- `docs/references/component-inventory.md` — source-backed Construct Lifecycle
  component catalog, chunk plan, and implementation status.
- `docs/references/components/` — one source contract per cataloged family.
- `docs/references/logos/` — retained official Construct Lifecycle marks.

Construct Lifecycle uses Inter for UI text and DM Mono for operational metadata.
Use vivid blue for primary actions and lifecycle emphasis, navy for navigation,
amber for attention, and semantic green/red only for success and danger. Keep
surfaces compact, project-centered, and readable; avoid decorative effects that
...
`@workspace/construct-lifecycle-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/construct-lifecycle-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/construct-lifecycle-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/construct-lifecycle-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/construct-lifecycle-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/construct-lifecycle-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/construct-lifecycle-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/construct-lifecycle-design-system/docs/migrating-expo.md`
