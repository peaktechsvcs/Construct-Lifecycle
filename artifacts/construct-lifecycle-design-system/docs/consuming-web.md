# Consuming Construct Lifecycle Design System in web apps

Read `artifacts/construct-lifecycle-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/construct-lifecycle-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/construct-lifecycle-design-system/styles.css";
```
...
`node_modules/@workspace/construct-lifecycle-design-system/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/construct-lifecycle-design-system/hooks/use-toast";
```
...
`@workspace/construct-lifecycle-design-system/components/ui/button`. Run the app's typecheck
