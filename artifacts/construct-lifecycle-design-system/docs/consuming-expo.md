# Consuming Construct Lifecycle Design System in Expo apps

Read `artifacts/construct-lifecycle-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/construct-lifecycle-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/construct-lifecycle-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/construct-lifecycle-design-system/lib/native-theme";
import { useColors } from "@workspace/construct-lifecycle-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/construct-lifecycle-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/construct-lifecycle-design-system/components/native/badge";
import { Button } from "@workspace/construct-lifecycle-design-system/components/native/button";
import { Card } from "@workspace/construct-lifecycle-design-system/components/native/card";
```
...
Import and render
`@workspace/construct-lifecycle-design-system/components/native/button`, then run Expo
