# Migrating Expo UI to Construct Lifecycle Design System

Read `artifacts/construct-lifecycle-design-system/docs/AGENTS.md` and
`artifacts/construct-lifecycle-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/construct-lifecycle-design-system/lib/native-theme` and
  `@workspace/construct-lifecycle-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/construct-lifecycle-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/construct-lifecycle-design-system` and retains only
