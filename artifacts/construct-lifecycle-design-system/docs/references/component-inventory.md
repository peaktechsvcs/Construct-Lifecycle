...
| Error Panel | [error-panel.md](components/error-panel.md) | Button, lucide-react | Shared request failure recovery | 2 | pending |
| Stat Card | [stat-card.md](components/stat-card.md) | React, lucide-react | Dashboard summary metrics | 2 | pending |
| Page Title | [page-title.md](components/page-title.md) | React | Shared page hierarchy and action slot | 2 | pending |
| Activity List | [activity-list.md](components/activity-list.md) | Empty State | Repeated project activity timeline | 2 | pending |