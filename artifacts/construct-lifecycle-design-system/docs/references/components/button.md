...
padding, visible focus treatment, and reduced opacity plus blocked pointer intent
when disabled. Primary is vivid blue; danger uses a restrained tint rather than
a solid red surface.