...
export function Bids() { const params = useParams<{ id?: string }>(); const id = params.id ? Number(params.id) : null; return id && Number.isFinite(id) ? <BidDetail id={id} /> : <BidList />; }
export default Bids;