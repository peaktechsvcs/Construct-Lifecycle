  ...
  return (
    <div className="animate-rise">
      ...
      <PageTitle
        ...
        action={canManage ? <div className="flex gap-2"><Button variant="outline" onClick={() => setShowEdit(true)}><Pencil size={15} /> Edit</Button><Link className={linkButtonClass} href={`/projects?customerId=${customer.id}`}><Plus size={15} /> New project</Link></div> : <Link className={linkButtonClass} href={`/projects?customerId=${customer.id}`}><Plus size={15} /> New project</Link>}
      />
