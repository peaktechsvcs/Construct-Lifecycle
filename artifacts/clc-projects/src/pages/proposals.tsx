...
export function Proposals() { const params = useParams<{ id?: string }>(); const id = params.id ? Number(params.id) : null; return id && Number.isFinite(id) ? <ProposalDetail id={id} /> : <ProposalList />; }
